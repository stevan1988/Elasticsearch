...
import com.todcode.elasticsearch.storage.StorageFileNotFoundException;
...
public class FileUploadTests {
  ...
  public void shouldListAllFiles() throws Exception {
    ...
    this.mvc.perform(get("/uploadFile")).andExpect(status().isOk())
  ...
  public void shouldSaveUploadedFile() throws Exception {
    ...
    this.mvc.perform(fileUpload("/uploadFile").file(multipartFile)).andExpect(status().isFound())
